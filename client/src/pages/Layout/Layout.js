                ...
                <div className="sidebar">
                    ...
                    <div className="side-nav font-medium">
                        <Link to="/dashboard/events"> 
                            <div className="side-nav-link" id="events" onClick={() => handleSideClick("events")}>
                                <span><img src={events}></img></span>
                                Events
                            </div>
                        </Link>
                        <Link to="/dashboard/myevents">
                            <div className="side-nav-link" id="my-events" onClick={() => handleSideClick("my-events")}>
                                <span><img src={myEvents}></img></span>
                                My Events
                            </div>
                        </Link>
                        <Link to="/dashboard/proshow">
                            <div className="side-nav-link" id="proshow" onClick={() => handleSideClick("proshow")}>
                                <span><img src={proshow}></img></span>
                                Proshow
                            </div>
                        </Link>
                        <Link to="/dashboard/delegatecard">
                            <div className="side-nav-link" id="delegate-card" onClick={() => handleSideClick("delegate-card")}>
                                <span><img src={delegateCard}></img></span>
                                Delegate Cards
                            </div>
                        </Link>
                    </div>
