    ...
    try{
        ...
        if (token.length >= 20) {
            ...
            if (!user)
                return res
                    .status(200)
                    .send({ success: false, msg: 'User not found or proshow pass not purchased' });
            ...
            if (!user)
                return res
                    .status(400)
                    .send({ msg: 'User not found or proshow pass not purchased', success: false });
