...
const updateEvent = async (req, res) => {
  try {
    ...
    if (eventDateTime) {
      ...
      console.log('Date Time is ', eventDateTime);
      console.log('Date Time is ', registrationDeadline);
      //print comparison registrationDeadline and eventDateTime
      console.log(registrationDeadline, eventDateTime);
      console.log(registrationDeadline > eventDateTime);
      if (registrationDeadline > eventDateTime)
        return res.send({
          msg: 'Registration Deadline should be less than Event Start Time',
          success: false,
        });
